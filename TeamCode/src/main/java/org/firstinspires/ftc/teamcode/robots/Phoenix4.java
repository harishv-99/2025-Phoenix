 ...
 *
 * <ul>
 *   <li>{@link edu.ftcphoenix.fw.drive.Drives#DEFAULT_FRONT_LEFT_MOTOR_NAME DEFAULT_FRONT_LEFT_MOTOR_NAME}:
 *       {@code "frontLeftMotor"}</li>
 *   <li>{@link edu.ftcphoenix.fw.drive.Drives#DEFAULT_FRONT_RIGHT_MOTOR_NAME DEFAULT_FRONT_RIGHT_MOTOR_NAME}:
 *       {@code "frontRightMotor"}</li>
 *   <li>{@link edu.ftcphoenix.fw.drive.Drives#DEFAULT_BACK_LEFT_MOTOR_NAME DEFAULT_BACK_LEFT_MOTOR_NAME}:
 *       {@code "backLeftMotor"}</li>
 *   <li>{@link edu.ftcphoenix.fw.drive.Drives#DEFAULT_BACK_RIGHT_MOTOR_NAME DEFAULT_BACK_RIGHT_MOTOR_NAME}:
 ...
 * </ol>
 */
@TeleOp(name = "Phoenix4", group = "Framework Examples")
public final class Phoenix4 extends OpMode {
