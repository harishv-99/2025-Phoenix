...
//        armRaiserMotor = hardwareMap.get(DcMotor.class, "armRaiserMotor");
        ...
        leftShooterMotor = hardwareMap.get(DcMotor.class, "launch1");
        rightShooterMotor = hardwareMap.get(DcMotor.class, "launch2");
...
//                armRaiser();
    ...
    private void shoot() {
        if (gamepad1.y) {
            rightShooterMotor.setPower(0.9);
            leftShooterMotor.setPower(0.9);
        }
        else {
