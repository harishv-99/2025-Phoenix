 ...
 * </pre>
 *
 * <p>Note: This base class does <b>not</b> know about Gamepads or Bindings. Those are TeleOp-only concerns.</p>
 *
 * @deprecated Legacy base class retained for reference. Prefer a plain FTC LinearOpMode (or task-driven Auto) that owns a robot container and follows the Phoenix loop contract explicitly.
 */
@Deprecated
