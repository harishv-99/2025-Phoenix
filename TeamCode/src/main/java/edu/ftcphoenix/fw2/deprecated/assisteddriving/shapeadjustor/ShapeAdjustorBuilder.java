package edu.ftcphoenix.fw2.deprecated.assisteddriving.shapeadjustor;
...
import edu.ftcphoenix.fw2.deprecated.assisteddriving.AbstractGuidanceAdjustor;
...
import edu.ftcphoenix.fw2.deprecated.assisteddriving.shapeadjustor.closestpointadjustor.ClosestPointAdjustorData;
...
class ShapeAdjustor extends AbstractGuidanceAdjustor {
    ...
    public PoseVelocity2d forceAdjustPoseVelocity(Pose2d poseRobot,
        ...
        Vector2d vecunClosestTangent = GeomUtil.normalize(GeomUtil.getTangentTowards(vecdClosestPoint, poseRobot.position));
        Vector2d vecunClosestNormal = GeomUtil.normalize(GeomUtil.getNormalTowards(vecdClosestPoint,
                poseRobot.position));

        Robot.g_Robot.getTelemetry().addData("norm tow", GeomUtil.getNormalTowards(vecdClosestPoint,
                poseRobot.position));
        ...
        double magfClosestNormal = GeomUtil.getMagnitudeFactorOfProjection(vecMoveRobot, vecunClosestNormal);
        double magfClosestTangent = GeomUtil.getMagnitudeFactorOfProjection(vecMoveRobot, vecunClosestTangent);
